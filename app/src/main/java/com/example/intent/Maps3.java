...
public class Maps3 extends FragmentActivity implements OnMapReadyCallback,
    ...
    private static final String TAG = Maps3.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.frag_maps2);
...
//        mStartUpdatesButton.setOnClickListener(op);
//        mStopUpdatesButton.setOnClickListener(op);
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(Maps3.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(Maps3.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            mMap.clear();
            mMap.addMarker(new MarkerOptions().position(myLoc).title("Kimi no ichi"));
            ...
            showSnackbar(R.string.permission_rationale,
                    android.R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(Maps3.this,
